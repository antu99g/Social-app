...
export const removeFriendReq = async (id, self) => {
   try {
      const response = await customFetch(`/user/friend/remove_request?id=${id}&self=${self}`, {
         method: "POST",
      });
      return response;
   } catch (err) {
...
export const fetchUserDetails = async (id) => {
   try {
      const response = await customFetch(`/user/${id}/details`, {method: 'GET'});
      return response;
   } catch (err) {
      return {
         success: false,
...
export const updateUserData = async (data) => {
   try {
      const response = await customFetch('/user/edit', {method: 'POST', body: data});
      return response;
   } catch (err) {
      return {
         success: false,
...
export const updateUserImage = async (data) => {
   try {
      const response = await customFetch('/user/edit/avatar', {method: 'POST', body: data});
      return response;
   } catch (err) {
      return {
         success: false,
...
export const editPostDetails = async (postid, data) => {
   try {
      const response = await customFetch(`/post/${postid}/edit`, {method: 'POST', body: data});
      return response;
   } catch (err) {
      return {
         success: false,
...
export const deletePost = async (data) => {
   try {
      const response = await customFetch(`/post/${data}/delete`, {method: 'DELETE'});
      return response;
   } catch (err) {
      return {
         success: false,
